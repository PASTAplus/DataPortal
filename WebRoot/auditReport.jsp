...
<%
    ...
    if (auditRecordLimit != null && !auditRecordLimit.equals("")) {
        limitHTML = "<sup>*</sup><small><em>Only the first " + auditRecordLimit +
                " matching audit records will be displayed.</em></small>";
    }
                ...
                <div class="box_shadow box_layout">
                    <div class="row-fluid">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                <!-- Content -->
                                <p>Review an audit report<sup>*</sup> by entering your criteria into one or more of the
                                    filters below.</p>
                                <hr/>
                                <form id="auditReport" action="./auditReport" method="post" name="auditReport">
                                    <div class="section">
                                        <table>
                                            <tr>
                                                <td>
                                                    <label class="labelBold">Data Package Manager Service
                                                        Method:</label>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="select-width-auto" name="code">
                                                        ...
                                                        <option value="450">450 Blocked by Windows Parental Controls
                                                        </option>
