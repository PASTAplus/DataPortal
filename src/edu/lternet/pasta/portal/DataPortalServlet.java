...
public class DataPortalServlet extends HttpServlet {
  ...
  protected static final String LOGIN_WARNING =
          "Please login with your approved account or contact our " +
          "<a href=\"mailto:support@edirepository.org?Subject=EDI%20Data%20Portal%20error\" target=\"_top\">" +
          "<u>support team</u></a> to approve your user account for use with this tool.";
