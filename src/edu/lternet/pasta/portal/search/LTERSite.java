...
public static final String[] siteNames = {
    ...
    "(BLE) Beaufort Lagoon Ecosystems LTER",
    ...
    "(COS) City of Seattle - Seattle Public Utilities",
    "(CWT) Coweeta LTER",
